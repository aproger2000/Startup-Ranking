...
METHODOLOGY = {
    "scope": "Компании, работающие преимущественно на российском рынке, по всем отраслям, разбитые на 4 раздела по "
             "возрасту/стадии: «Молодые» (до 3 лет), «Зрелые» (3–10 лет), «Возрастные, но растущие» (старше 10 лет, "
    ...
    "limitations": [
        ...
        "Раздел «Возрастные, но растущие» (>10 лет) — это новый охват (добавлен в сентябре 2026): критерий «растёт» "
