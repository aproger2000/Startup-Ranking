...
METHODOLOGY = {
    "scope": "Компании, основанные примерно с 2018–2019 года (возраст примерно до 7 лет), работающие преимущественно на "
             "российском рынке, по всем отраслям.",
    "sources": "ТЕХУСПЕХ (ts.vedomosti.ru), РБК «Топ-50 быстрорастущих компаний», TAdviser500, Smart Ranking (Fintech, "
               ...
               "Inc. Russia. Прямой автоматический сбор с rusprofile.ru недоступен (сервис отдаёт 403 при программном обращении).",
    "score_formula": "Скор = Выручка (0–38 баллов, лог-шкала) + Рост выручки (от −24 до +24, знак сохраняется) + "
                      ...
                      "автоматически сервером при каждом добавлении/обновлении записи.",
    "limitations": [
        ...
        "База не включает компании старше ~7 лет, закрытые компании и компании в процедуре банкротства — они переводятся "
        "в статус closed/distress и скрываются из основного рейтинга.",
